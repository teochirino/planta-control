...
class KPIService
{
    ...
    /**
     * Calcular estado del área
     */
    public function calculateAreaStatus(DailyProgram $program = null, WorkCenter $workCenter): array
    {
        if (!$program) {
            return [
                'status' => 'idle',
                ...
                'label' => 'Sin datos',
                'time' => '00:00:00',
                'message' => 'No hay programa diario registrado',
            ];
        }
        ...
        if ($activeStrike) {
            ...
            return [
                ...
                'message' => 'Paro activo en el área',
            ];
        }
