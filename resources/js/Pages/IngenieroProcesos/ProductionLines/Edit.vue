<template>
    <div class="min-h-screen" style="background: #eaf0f5;">
        ...
        <div class="p-6 ml-16">
            ...
            <h1 class="text-3xl font-bold mb-6" style="color: #0b2a40;">Editar Línea de Producción</h1>
            ...
            <div class="rounded-lg p-6" style="background: #fff; border: 1px solid #d4dee8; box-shadow: 0 2px 12px rgba(11,28,40,.08);">
                <form @submit.prevent="submit">
                    ...
                    <div class="flex gap-4">
                        ...
                        >
                            {{ processing ? 'Guardando...' : 'Actualizar Línea' }}
                        </button>
                        <Link 
...
const form = useForm({
    id_work_center: props.productionLine.id_work_center,
    title: props.productionLine.title,
    installed_capacity: props.productionLine.installed_capacity,
    cost: props.productionLine.cost,
});

const processing = computed(() => form.processing);

const submit = () => {
    form.put(route('ingeniero-procesos.production-lines.update', props.productionLine.id));
};
</script>
