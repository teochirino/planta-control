            ...
            >
                <div class="flex flex-col h-full">
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-2">
                        ...
                        <Link 
                            :href="route('gerente-mantenimiento.dashboard') + '?view=breakdowns'" 
                            class="sidebar-link"
                            :class="{ 'active': route().current('gerente-mantenimiento.dashboard') && $page.url.includes('breakdowns') }"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <Link 
                            :href="route('gerente-mantenimiento.dashboard') + '?view=reports'" 
                            class="sidebar-link"
                            :class="{ 'active': route().current('gerente-mantenimiento.dashboard') && $page.url.includes('reports') }"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
