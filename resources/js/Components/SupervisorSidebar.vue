            ...
            >
                <div class="flex flex-col h-full">
                    <div class="p-6 border-b" style="border-color: #174060;">
                        <h2 class="text-xl font-bold text-white">Supervisor</h2>
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                        ...
                        <div class="mb-4">
                            ...
                            <Link 
                                ...
                                class="sidebar-link"
                                :class="{ 'active': route().current('supervisor.dashboard') }"
                            >
                            ...
                            <Link 
                                :href="route('supervisor.information-panel')" 
                                class="sidebar-link"
                                :class="{ 'active': route().current('supervisor.information-panel') }"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <Link 
                                :href="route('supervisor.tv-panels')" 
                                class="sidebar-link"
                                :class="{ 'active': route().current('supervisor.tv-panels') }"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <Link 
                                :href="route('supervisor.daily-production')" 
                                class="sidebar-link"
                                :class="{ 'active': route().current('supervisor.daily-production') }"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <Link 
                                :href="route('supervisor.center-history')" 
                                class="sidebar-link"
                                :class="{ 'active': route().current('supervisor.center-history') }"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span>Historial por Centro</span>
                            </Link>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <Link 
                                ...
                                class="sidebar-link"
                                :class="{ 'active': route().current('supervisor.register-adjustments') }"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <Link 
                                ...
                                class="sidebar-link"
                                :class="{ 'active': route().current('supervisor.production-adjustments') }"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                        ...
                        <!-- Sección Admin (solo para perfil 2) -->
                        <div v-if="$page.props.auth.user.id_profile === 2" class="mb-4">
                            <p class="text-xs font-semibold uppercase tracking-wider mb-2 px-4" style="color: #6a8090;">Administración</p>
                            <Link 
                                :href="route('permisos')" 
                                class="sidebar-link"
                                :class="{ 'active': route().current('permisos') }"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
