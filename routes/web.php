...
Route::middleware('auth')->group(function () {
    ...
    // Suplantar usuario (solo Administrador puede iniciar; "leave" lo usa quien
    // esté siendo suplantado en ese momento, por eso va fuera del middleware 'admin').
    Route::impersonate();
    ...
    Route::prefix('supervisor')->name('supervisor.')->group(function () {
        ...
        Route::get('/tv-panels', [SupervisorController::class, 'tvPanels'])->name('tv-panels');
